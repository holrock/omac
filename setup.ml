...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87968f1e9347d8f68bd2c634e9acdf7f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test_main.native", []))];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["holrock <ispeporez@gmail.com>"];
          homepage = None;
          bugreports = None;
          synopsis = "image proxy";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\251\030\002h\148O\212p\192h\005pM\2540\247";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
